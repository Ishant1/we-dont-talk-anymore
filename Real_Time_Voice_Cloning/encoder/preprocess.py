...
from Real_Time_Voice_Cloning.encoder.config import librispeech_datasets, anglophone_nationalites
...
class DatasetLog:
    ...
    def _log_params(self):
        from Real_Time_Voice_Cloning.encoder import params_data
